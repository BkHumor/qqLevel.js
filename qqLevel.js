    ...
    _qqLevel = (function () {
            ...
            function y(level, img_conf) {
                    ...
                    if(img_conf.length > 0) {
                            img_none = '<img src="'+img_conf[0]+'" width="13" height="13" style="opacity: 0.65">';
                            img_star = '<img src="'+img_conf[1]+'" width="13" height="13" style="opacity: 0.65">';
                            img_moon = '<img src="'+img_conf[2]+'" width="13" height="13" style="opacity: 0.65">';
                            img_sun  = '<img src="'+img_conf[3]+'" width="13" height="13" style="opacity: 0.65">';
                            img_king = '<img src="'+img_conf[4]+'" width="13" height="13" style="opacity: 0.65">';
                    }
                    if(level < 1) {
                            return img_none;
                    }
